...
| `BR_NIS` | EN: none found: Caixa, eSocial (rules only validate against the CNIS database), Serpro, open data / PT: nenhuma: Caixa, eSocial (regras só validam na base do CNIS), Serpro, dados abertos | no / não | experimental |
| `BR_CNH` | [Contran, Res. 511/2014, art. 2, I](https://www.gov.br/transportes/pt-br/assuntos/transito/conteudo-contran/resolucoes/resolucao5112014.pdf) | partial / parcial: EN: layout 9 chars + 2 check digits confirmed, weights not published (Senatran, Serpro Datavalid checked) / PT: layout 9 + 2 DVs confirmado, pesos não publicados | experimental |
